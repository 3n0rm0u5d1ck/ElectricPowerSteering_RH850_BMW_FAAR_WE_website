...
<img
src="ElectricPowerSteering_RH850_BMW_FAAR_WE_website/docs/CM475A_TSG31CfgAndUse_Impl/doc/mediax/media/image1.png"
style="width:3.41597in;height:5.78403in" />
...
|                      |                   |      |     |     |
|----------------------|-------------------|------|-----|-----|
| **Function Name**    | MissUpdtCntrDiagc | Type | Min | Max |
| **Arguments Passed** | None              |      |     |     |
| **Return Value**     | None              |      |     |     |
